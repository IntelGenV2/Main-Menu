...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Intel Byte 256 desktop chat client")
    parser.add_argument("--server", default="", help="Intel Byte server WebSocket URL (ws:// or wss://)")
...
def main() -> int:
    ...
    if not settings.get("user_id"):
        QMessageBox.warning(None, "Missing profile", "A user ID is required. Run setup again or use --user.")
        return 1
